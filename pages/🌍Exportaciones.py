...
st.write('por tipo de producto en lintros')
...
st.write('por tipo de producto en valor Fob')

qu = 'select periodo,fob,producto from info_expo_anio_mes_tot ;'  
dfpv1 = conn.query(qu, ttl="0"),
#if prov != "Todas": 
dfpv1 = dfpv1[0]
...
df = dfpv1.pivot_table(index='periodo', columns='producto', values='fob')
