...
option = {
    ...
    "tooltip": {"trigger": "item", "triggerOn": "mousemove",
                "formatter": JsCode("function (info) { if (info.dataType === 'edge')  { return info.data.porceVar || (info.data.porcePais + ' > ' + info.target + '<br/>Lts ' + info.data.value.toLocaleString()); } else {return info.data.name}};").js_code,  
