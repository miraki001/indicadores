...
option = {
    ...
    "tooltip": {"trigger": "item", "triggerOn": "mousemove",
                "formatter": JsCode("function (info) { if (info.dataType === 'edge')  { return info.porceVar || (info.porcePais + ' > ' + info.target + '<br/>FOB: USD ' + info.data.value.toLocaleString()); } else {return info.data.name}};").js_code,  
