...
@st.cache_data
def query1():
  df4 = conn.query('select s.anio anio,s.sup sup,s.provincia,s.iso_loc, s.color ,s.variedad,s.departamento,s.tipouva tipoVariedad,s.sistemaconduccion,s.pie from superficieVariedad_m s where s.anio = 2023  ;', ttl="0"),
  return df4
df4 = query1()
df1 = df4[0]
