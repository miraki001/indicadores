...
with tab2:
    ...
    #styled_df.style.format(precision=2, thousands=“”, decimal=“.”)
    ...
    styled_df = pivot_table_basic.style.format({'2022': precision=0, thousands=".", decimal="," , '2023': '{:.2f}'}).applymap(bgcolor_positive_or_negative, subset=['2023/2022','2024/2023'])
