...
def exporta_mosto_producto():
    ...
    QUERY_INICIAL = "select distinct anio,producto  from exportaciones2_m where producto = 'Mosto' and codigoproducto like '%CONCENTRADO%' ; "
    ...
    if "filtrosmp" not in st.session_state:
    ...
    df_anual = df_filtered.groupby(['producto'], as_index=False)[['fob', 'litros']].sum()
    dv = df_anual.copy()
    total = []
    tot1 = []
    tot2 = []
    ...
    option = {
        ...
        "title": {
                "text": 'Exportaciones de Mosto por tipo de producto en Tn. ',
                "textStyle": {
                        "fontSize": 12,
                },                  
                "subtext": '',
    ...
    option = {
        ...
        "title": {
                "text": 'Exportaciones de Mosto por tipo de producto en Fob ',
                "textStyle": {
                        "fontSize": 12,
                },                  
                "subtext": '',
