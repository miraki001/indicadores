...
def exporta_mosto_evo():
    ...
    if dv1.empty:
        ...
        #dv1 = dv1.astype({'Fob' : int, 'Toneladas': int } )
        ...
        option = {
          "color": [
            ...
            "series": [
                {"data": dv1["Toneladas"].tolist(),"position" : 'rigth', "type": "line", "name": "Toneladas", "yAxisIndex": 0, "formatter": =v=>v.toFixed(0)  },
                {"data": dv1["Fob"].toFixed(0), "type": "bar", "name": "Fob", "yAxisIndex": 1,  "valueformatter": =v=>v.toFixed(0) },
